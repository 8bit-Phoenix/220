...
def squares():
    ...
    close = Text(Point(200, 5), "Click to close window")
    close.draw(win)
    win.getMouse()
    win.close()
...
def rectangle():
    ...
    perimeter_text = Text(Point(200, 20), "The perimeter is: " + str(perimeter))
    area_text = Text(Point(200, 35), "The area is: " + str(area))
    close = Text(Point(200, 5), "Click to close window")
